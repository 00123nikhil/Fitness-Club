...
<h3 align="center" style="color: white;">Login to your Admin Account</h3>
<br>
...
<div class="log-form">
  ...
  <form method="POST">
    ...
    <button type="submit" class="btn">Login</button>
     <a class="" href="login.php">&nbsp&nbsp&nbsp User Login </a>
            ...
            if(isset($_POST['username']) && !empty($_POST['username']) AND isset($_POST['password']) && !empty($_POST['password'])){
                ...
                if($match > 0){
                  ...
                  echo "<script>
                    ...
                    location.replace('adminproductlist.php');
                    </script>
