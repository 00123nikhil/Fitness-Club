  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
         <li class="nav-item">
          <a class="nav-link active" href="info.php">IMPORATNCE OF HEALTH</a>
        </li>
        <li class="nav-item">
        ...
        <div class="table-responsive mt-2">
          <table class="table table-bordered table-striped text-center" style="background-color: white;">
            <thead>
              <tr>
                <td colspan="7">
                  <h2 class="text-center text-info m-0">Products cart</h2>
                </td>
              </tr>
              <tr>
                <th>ID</th>
                ...
                <th>Total Price</th>
                <th>
                  <a href="action.php?clear=all" class="badge- badge p-1" onclick="return confirm('Are you want clear');">&nbsp;&nbsp;Clear Cart</a>
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td colspan="2"><b>Your proudcts Total</b></td>
                <td><b>&nbsp;&nbsp;<?= number_format($grand_total,2); ?></b></td>
                <td>
                  <a href="checkout.php" class="btn btn-success <?= ($grand_total > 1) ? '' : 'disabled'; ?>">&nbsp;&nbsp;Checkout</a>
                </td>
              </tr>
            </tbody>
          </table>
